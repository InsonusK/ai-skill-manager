...
description: Define the base structure for Python CLI applications with clear separation
  between CLI, commands, and reusable services/functions
---
...
- **Logging is mandatory**: every CLI application must set up logging and support a `--debug` flag disabled by default, following [logging-principle](.claude/skills/logging-principle/SKILL.md).

# Requirements
SOLUTION:
- [logging-principle](.claude/skills/logging-principle/SKILL.md)
...
PROJECT:
- [{App} project](.claude/skills/solution-default-cli/Implementation/{App}.create.md) - create - root folder for the CLI application
  - [cli.py](.claude/skills/solution-default-cli/Implementation/{App}.cli.py.create.md) - create - entry point that wires subcommands and logging
  - [cli/__init__.py](.claude/skills/solution-default-cli/Implementation/{App}.cli.__init__.py.create.md) - create - make cli a package
  - [cli/{Command}.py](.claude/skills/solution-default-cli/Implementation/{App}.cli.{Command}.py.create.md) - create - argparse wiring for one command
  - [command/__init__.py](.claude/skills/solution-default-cli/Implementation/{App}.command.__init__.py.create.md) - create - make command a package
  - [command/{Command}.py](.claude/skills/solution-default-cli/Implementation/{App}.command.{Command}.py.create.md) - create - business logic for one command
  - [functions/__init__.py](.claude/skills/solution-default-cli/Implementation/{App}.functions.__init__.py.create.md) - create - make functions a package
  - [functions/{Function}.py](.claude/skills/solution-default-cli/Implementation/{App}.functions.{Function}.py.create.md) - create - reusable helper function example
  - [service/__init__.py](.claude/skills/solution-default-cli/Implementation/{App}.service.__init__.py.create.md) - create - make service a package
  - [service/{Service}.py](.claude/skills/solution-default-cli/Implementation/{App}.service.{Service}.py.create.md) - create - reusable service example
...
See [run-cli-command](.claude/skills/solution-default-cli/diagrams/run-cli-command.mmd)
...
# Rules
## MUST
- [cli.py.create](.claude/skills/solution-default-cli/Implementation/{App}.cli.py.create.md#MUST)
- [cli/{Command}.py.create](.claude/skills/solution-default-cli/Implementation/{App}.cli.{Command}.py.create.md#MUST)
- [command/{Command}.py.create](.claude/skills/solution-default-cli/Implementation/{App}.command.{Command}.py.create.md#MUST)
...
## SHOULD NOT
- [cli/{Command}.py.create](.claude/skills/solution-default-cli/Implementation/{App}.cli.{Command}.py.create.md#SHOULD NOT)
- Put business logic directly in the CLI layer.

## MUST NOT
- Use `print` for logging or operational messages (see [logging-principle](.claude/skills/logging-principle/SKILL.md)).
...
- **Use `print` instead of logging**
  ...
  - Instead: use the `logging` module and follow [logging-principle](.claude/skills/logging-principle/SKILL.md).
