...
from ai_skill_manager.models import GitHubSource, LocalSource, Skill, Source
...
class TestSkillSourceLink(unittest.TestCase):
    ...
    def test_skill_has_optional_source(self):
        ...
        skill = Skill(file_path=md, folder_path=None, source=source)
    ...
    def test_skill_requires_source(self):
        ...
        with self.assertRaises(TypeError):
            Skill(file_path=md, folder_path=None)
